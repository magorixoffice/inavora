                ...
                >
                    ...
                    <div className="space-y-8 text-gray-300 leading-relaxed">
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
                            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy.section1_title')}</h2>
                            <p>
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
                            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy.section2_title')}</h2>
                            <p className="mb-4">
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
                            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy.section3_title')}</h2>
                            <p>
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
                            <h2 className="text-2xl font-bold text-white mb-4">{t('privacy.section4_title')}</h2>
                            <p>
