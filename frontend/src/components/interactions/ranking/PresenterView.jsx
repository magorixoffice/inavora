      ...
      <div className="rounded-2xl sm:rounded-3xl border border-[#2A2A2A] bg-[#1F1F1F] p-6 sm:p-10 shadow-xl">
        <div className="flex flex-col gap-4 sm:gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#E0E0E0]">{slide?.question || 'Ranking results'}</h2>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative group">
                        ...
                        />
                        <div className="pointer-events-none absolute inset-y-0 left-4 flex items-center text-sm font-semibold text-[#E0E0E0] opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                          Score: {item.score}
                        </div>
                      </div>
                    </div>
