  ...
  return (
    <div className="space-y-6">
      <div className="bg-[#1F1F1F] rounded-lg p-6 border border-[#2A2A2A]">
        <h3 className="text-xl font-semibold text-white mb-4">PowerPoint Presentation</h3>
        ...
        <div className="mb-6">
          ...
          <div className="aspect-video bg-[#2A2A2A] rounded-lg flex items-center justify-center border border-[#3B3B3B]">
            <div className="text-center">
              ...
              <p className="text-gray-400">PowerPoint Presentation</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-[#242424] p-4 rounded-lg border border-[#3B3B3B]">
            <div className="text-2xl font-bold text-orange-400">PowerPoint</div>
            <div className="text-sm text-gray-400">File Type</div>
          </div>
          <div className="bg-[#242424] p-4 rounded-lg border border-[#3B3B3B]">
            <div className="text-2xl font-bold text-blue-400">Presentation</div>
